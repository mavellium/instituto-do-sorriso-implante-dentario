  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-background to-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 xl:grid-cols-4 gap-6 max-w-7xl mx-auto mb-12">
          {/* WhatsApp */}
          <Card className="p-6 text-center border-[rgb(229,231,235)] hover:border-[rgb(178,212,247)] transition-all duration-300 hover:shadow-[0_10px_25px_-5px_rgba(178,212,247,0.2)] bg-[rgb(255,255,255)] group">
            ...
            <Button
              onClick={() =>
                handleWhatsAppClick(
                  "Olá! Gostaria de agendar uma avaliação gratuita e saber mais sobre os tratamentos de implante dentário."
                )
              }
              variant="outline"
          ...
          <Card className="p-6 text-center border-[rgb(229,231,235)] hover:border-[rgb(178,212,247)] transition-all duration-300 hover:shadow-[0_10px_25px_-5px_rgba(178,212,247,0.2)] bg-[rgb(255,255,255)] group">
            ...
            <h3 className="text-lg font-bold mb-2 text-[rgb(52,66,86)]">Telefone</h3>
            <p className="text-sm text-[rgb(130,140,160)] mb-4">
              Ligue e fale com nossa recepção
            </p>

            <div className="space-y-1 mb-4">
              <p className="text-sm font-semibold text-[rgb(0,119,255)]">(14) 9656-2383</p>
          ...
          <Card className="p-6 text-center border-[rgb(229,231,235)] hover:border-[rgb(178,212,247)] transition-all duration-300 hover:shadow-[0_10px_25px_-5px_rgba(178,212,247,0.2)] bg-[rgb(255,255,255)] group">
            ...
            <div className="space-y-1 mb-4">
              ...
              <p className="text-xs text-[rgb(0,119,255)] font-medium">Emergências: 24h</p>
            </div>

            <Button
              onClick={() => handleWhatsAppClick("Olá! Preciso de atendimento de emergência.")}
              variant="outline"
              className="w-full border-[rgb(0,119,255)] text-[rgb(0,119,255)] hover:bg-[rgb(0,119,255)] hover:text-white h-10"
            >
        ...
        <div className="text-center mt-12 p-8 rounded-xl 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              onClick={() => handleWhatsAppClick("Olá! Gostaria de mais informações sobre implantes dentários e agendar minha avaliação gratuita.")}
              size="lg"
